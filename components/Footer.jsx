    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="mx-auto max-w-7xl px-6 py-12 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3 md:gap-12">
          ...
          <div>
            ...
            <p className="mt-4 text-sm leading-relaxed">
              Transform your fitness journey with personalized workouts and AI-powered tracking.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              <li>
                <Link href="#home" className="text-sm transition-colors hover:text-white">
                  Home
                </Link>
              </li>
              <li>
                <Link href="#features" className="text-sm transition-colors hover:text-white">
                  Features
                </Link>
              </li>
              <li>
        ...
        <div className="mt-12 border-t border-gray-800 pt-8">
          <p className="text-center text-sm">© {new Date().getFullYear()} FitTrack. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
